...
class PolicyGradient():
    ...
    def _build_model(self):
        model = Sequential()
        model.add(Dense(10, input_dim = self.s_size, activation = 'tanh', kernel_initializer=keras.initializers.RandomNormal(mean=0.0, stddev=0.3, seed=None), bias_initializer=keras.initializers.Constant(value=0.1)))
        model.add(Dense(self.a_size, activation = 'softmax', kernel_initializer=keras.initializers.RandomNormal(mean=0.0, stddev=0.3, seed=None), bias_initializer=keras.initializers.Constant(value=0.1)))
        return model
